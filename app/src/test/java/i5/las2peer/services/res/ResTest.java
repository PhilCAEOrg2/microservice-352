 ...
 *
 * This class provides a basic testing framework for the microservice Service 1. It was
...
public class ResTest {
  ...
  /**
   * 
   * Test for the NewTestCase_ID620791 method.
   * 
   */
  @Test
  public void testNewTestCase_ID620791() {
    ...
    try {
      ...
      ClientResponse result = c.sendRequest("GET", "/tesat", """
""", "text/plain", "*/*", new HashMap<>(), new Object[0]);
      System.out.println("Result of request with id: 385299: " + result.getResponse().trim());
    
      Assert.assertEquals("[462416]", 200, result.getHttpCode());
